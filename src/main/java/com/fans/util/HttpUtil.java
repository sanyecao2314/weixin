...
public class HttpUtil {
	...
	/**
	 * 发送 SSL POST 请求（HTTPS），K-V形式，通过SSL请求HTTPS连接，可以绕过证书验证
	 * 
	 * @param apiUrl
	 *            API接口URL
	 * @param params
	 ...
	 * @return
	 */
	public static HttpEntity doPostSSL(String apiUrl, Map<String, Object> params, CloseableHttpResponse response) {
	...
	/**
	 * 发送 SSL POST 请求（HTTPS），JSON形式，通过SSL请求HTTPS连接，可以绕过证书验证
	 * 
	 * @param apiUrl
	 *            API接口URL
	 * @param json
	 ...
	 * @return
	 */
	public static HttpEntity doPostSSL(String apiUrl, Object json, CloseableHttpResponse response) {
		CloseableHttpClient httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory())
				.setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
		HttpPost httpPost = new HttpPost(apiUrl);
		try {
	...
	public static HttpEntity doPostUploadSSL(String apiUrl, Object json, File file, CloseableHttpResponse response) {
		CloseableHttpClient httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory())
				.setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
		HttpPost httpPost = new HttpPost(apiUrl);
		try {
